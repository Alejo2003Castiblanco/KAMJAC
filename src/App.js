...
import Logo_dasaga from './img/Logo_dasaga.png';
    ...
    return(
        <div className="">
          ...
          <ul className="menu" >
            ...
            <a className="button" id='inicio' href="#iniciar" >Iniciar Sesion</a>
          </ul>
        </div>
    </nav>
        ...
        <div id="service" className="sectionn">
			...
			<div class="container">
              ...
              <img className="footer-logo" src={Logo_dasaga} alt={"Logo_dasaga"}/>
						</div>
						<ul class="footer-follow">
							<li><a href="#"><i class="fa fa-facebook"></i></a></li>
							<li><a href="#"><i class="fa fa-twitter"></i></a></li>
							<li><a href="#"><i class="fa fa-google-plus"></i></a></li>
							<li><a href="https://www.instagram.com/muebles_dasaga/"><i class="fa fa-instagram"></i></a></li>
